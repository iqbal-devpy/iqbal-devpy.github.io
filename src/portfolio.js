...
const skillsSection = {
  ...
  skills: [
    emoji("⚡ Architect and develop scalable GenAI applications using FastAPI, LangChain, LLaMA-based models, and modern prompt engineering techniques."),
    emoji("⚡ Design and deploy backend microservices with Node.js / FastAPI, optimized for real-world production workloads"),
    emoji("⚡ Containerize and orchestrate applications using Docker, with deployments on AWS, DigitalOcean, and modern cloud platforms."),
    emoji("⚡ Integrate third-party services and APIs including AWS services, Vector Databases, Postgresql, and more"),
...
const bigProjects = {
  ...
  projects: [
    ...
    {
      image: require("./assets/images/readmission.png"),
